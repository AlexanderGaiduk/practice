    ...
    const Intro: FC<IntroProps> = ({onSearch}) => {
        ...
        return(
            <div>
                ...
                {mode === "search" && <div className="searchModePadding"></div>}

                {mode === "trending" && <section className="hero is-medium has-background-grey-dark has-text-centered" style={{backgroundImage: `url("${!(undefined) ? randomPhoto.src.original : ""}")`}}>
                    <div className="hero-body">
                        ...
                        <a className="authorName p-3" href={!(undefined) ? randomPhoto.photographer_url : ""} target="_blank">
                            <p>Фотограф: {!(undefined) ? randomPhoto.photographer : ""}</p>
                        </a>
                    </div>
                </section>}
            </div>
            ...
            error
                ...
                : <Fragment>
                            ...
                            <Masonry gutter={20}>
                                {photos.map(photo => (
                                    <div key={photo.id} className="masonry-item">
                                            ...
                                            <img src={photo.src.large} alt="" onMouseOver={ (e) => {} } />
                    ...
                    <div className="is-flex is-justify-content-center py-6">
                        {((total_results > page * 6) || mode === "trending") && fetching && <div className="loading"></div>}
                    </div>
